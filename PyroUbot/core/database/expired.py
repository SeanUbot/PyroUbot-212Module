...
<b>ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴍᴇɴᴄᴏʙᴀ sᴇᴀɴ ᴜsᴇʀʙᴏᴛ! ᴊɪᴋᴀ ᴀɴᴅᴀ ᴍᴇɴʏᴜᴋᴀɪ ʟᴀʏᴀɴᴀɴ ᴋᴀᴍɪ, sɪʟᴀʜᴋᴀɴ ʙᴇʟɪ ᴜsᴇʀʙᴏᴛ ᴜɴᴛᴜᴋ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴɴʏᴀ sᴇᴄᴀʀᴀ ᴘᴇɴᴜʜ.</b>

<b>ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴇʟɪ, sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ: <a href=tg://openmessage?user_id={OWNER_ID}>@SeanXOffc</a> ᴀᴛᴀᴜ ᴊᴀʟᴀɴᴋᴀɴ ᴋᴏᴍᴀɴᴅᴏ /start</b></blockquote>
""",
...
<b>👨‍💼 <a href=tg://openmessage?user_id={OWNER_ID}>@SeanXOffc</a></b></blockquote>
